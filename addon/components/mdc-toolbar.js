...
export default Ember.Component.extend(MDCComponent, {
  ...
  createFoundation() {
    return new MDCToolbarFoundation({
      ...
      notifyChange: (evtData) => run.next(() => get(this, 'onchange')(evtData)),
      setStyle: (property, value) => run.next(() => this.setStyleFor('mdcStyles', property, value)),
      setStyleForTitleElement: (property, value) => run.next(() => this.setStyleFor('mdcTitleStyles', property, value)),
      setStyleForFlexibleRowElement: (property, value) => run.next(() => this.setStyleFor('mdcFirstRowStyles', property, value)),
