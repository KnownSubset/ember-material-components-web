...
export const createRippleAdapter = (component, overrides) => Object.assign({
  ...
  addClass: className => run.next(() => get(component, 'mdcClasses').addObject(className)),
  removeClass: className => run.next(() => get(component, 'mdcClasses').removeObject(className)),
  ...
  updateCssVariable: (varName, value) => run.next(() => component.setStyleFor('mdcStyles', varName, value)),
